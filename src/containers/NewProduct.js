      ...
      <div className="container">
        ...
        <form>
          <div class="form-group">
            ...
            <select class="form-control" id="typeSelect" value={this.state.type}>
          ...
          <div class="form-group">
            ...
            <input type="text" class="form-control" id="amountInput" placeholder="" value={this.state.amount} />
          </div>
          <button id="b1" class="btn btn-secondary" type="button" onClick={this.addProduct}>Add Product</button>
        </form>
