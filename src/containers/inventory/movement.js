...
import {getAll, getAllMovements, newMovement} from '../../redux/actions/inventoryActions'
        ...
        if(this.props.error && this.props.error.message){
          ...
          return (
            <div className="container">   
              ...
              <Link to={`/inventory`} class="btn btn-primary float-right" onClick={this.cleanError}>Back</Link>
            </div>
          )  
          ...
          return (
            <div className="container">   
              ...
              <Link to={`/inventory`} class="btn btn-primary float-right">Back</Link>
            </div>
          )  
        }        
      }
          ...
          <div className="container">
            ...
            <h4>Movement</h4>   
              ...
              <div class="form-group">
                  ...
                  <select class="form-control" id="id_productType" name="id_productType" 
